...
inline std::vector<ServerCommand> getServerCommands() {
  return {
    ...
    { "keepalive_count",
      ...
      nullptr },
    { "max_connections",
      CommandType::configTake1 | CommandType::configSizeT | CommandType::server,
      0,
      OFFSET_OF(ServerConfig, maxConnections),
      nullptr,
      nullptr },
    { "max_pending_connections",
      CommandType::configTake1 | CommandType::configSizeT | CommandType::server,
      0,
      OFFSET_OF(ServerConfig, maxPendingConnections),
      nullptr,
      nullptr },
    { "pending_timeout",
      CommandType::configTake1 | CommandType::configSizeT | CommandType::server,
      0,
      OFFSET_OF(ServerConfig, pendingTimeout),
      nullptr,
      nullptr }
  };
}
